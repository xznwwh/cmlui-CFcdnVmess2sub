...
// 设置优选地址api接口
let addressesapi = [
	'https://github.com/xznwwh/cmliu_WorkerVless2sub/blob/main/addressesapi.txt', //可参考内容格式 自行搭建。
...
let addressesnotlsapi = [
	'https://raw.githubusercontent.com/xznwwh/cmliu_WorkerVless2sub/main/addressesapi.txt',
];

let DLS = 8;//速度下限
let addressescsv = [
	'https://raw.githubusercontent.com/xznwwh/cmliu_WorkerVless2sub/main/addressescsv.csv', //iptest测速结果文件。
];

let subconverter = "url.v1.mk"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
let subconfig = "https://raw.githubusercontent.com/xznwwh/cmliu-ACL4SSR/main/clash-config.ini"; //订阅配置文件
